package com.zhongke.core.http.httpbase.interceptor.loging

import android.text.TextUtils
import com.zhongke.core.http.httpbase.ext.HttpLogUtils
import com.zhongke.core.http.httpbase.interceptor.CharacterHandler.Companion.jsonFormat
import com.zhongke.core.http.httpbase.interceptor.CharacterHandler.Companion.xmlFormat
import com.zhongke.core.http.httpbase.interceptor.loging.LogInterceptor.Companion.isJson
import com.zhongke.core.http.httpbase.interceptor.loging.LogInterceptor.Companion.isXml
...
class DefaultFormatPrinter : FormatPrinter{
    ...
    override fun printJsonRequest(
        ...
        val tag = getTag(true)
        HttpLogUtils.debugInfo(tag, REQUEST_UP_LINE)
        logLines(
            tag,
        ...
        HttpLogUtils.debugInfo(tag, END_LINE)
    }
    ...
    override fun printJsonResponse(
        ...
        HttpLogUtils.debugInfo(tag, RESPONSE_UP_LINE)
